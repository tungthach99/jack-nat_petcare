<?php  
    if (isset($_POST['submit_search'])) {
        $key = $_POST['keyw'];
        $sql = "SELECT *FROM tbl_don_dich_vu WHERE dien_thoai LIKE '%$key%' ORDER BY id_don_hang";
    }else{
        $sql = "SELECT *FROM tbl_don_dich_vu ORDER BY id_don_hang";
    }
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="index.php?page=ordered2&id=<?php echo $row['id_don_hang']; ?>" method="POST">
                                        <div class="input-group">
...
<?php  
    if (isset($_GET['id'])) {
        ...
        $sql_status = "UPDATE tbl_don_dich_vu SET trang_thai = '$status_order' WHERE id_don_hang = $id";
        $query = mysqli_query($conn, $sql_status);
        header("Location: index.php?page=ordered2;");
    }
?>