...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 22, 2021 lúc 07:29 AM
...
CREATE TABLE `tbl_dich_vu` (
  ...
  `mo_ta_dv` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
